...
parser.add_argument('--random', action='store_true', help='Use random cities')
parser.add_argument('--known', action='store_true', help='Use known cities')
...
if args.random:
    ...
    print("Please specify either --random or --known")
    exit(1)
